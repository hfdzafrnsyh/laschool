...
<head>
  ...
  <link href="{{asset('wp-school/vendor/fontawesome-free/css/all.min.css')}}" rel="stylesheet" type="text/css">
  <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet">

  <!-- Custom styles for this template-->
  <link href="{{asset('wp-school/css/sb-admin-2.min.css')}}" rel="stylesheet">
...
<div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="logo-text text-center mt-4 text-white" >
          <h3 style="font-size:50px;">School</h3>
          </div>
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-danger mb-4">Create Your Account</h1>
                  </div>
                  ...
                  <div class="text-center">
                  <a class="small text-primary" href="/login">Back to Login</a>
  ...
  <script src="{{asset('wp-school/vendor/jquery/jquery.min.js')}}"></script>
  <script src="{{asset('wp-school/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>

  <!-- Core plugin JavaScript-->
  <script src="{{asset('wp-school/vendor/jquery-easing/jquery.easing.min.js')}}"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{asset('wp-school/js/sb-admin-2.min.js')}}"></script>
